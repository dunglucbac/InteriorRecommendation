...
weightsPath = 'static/yolo/yolov4_custom_final.weights'
configPath = 'static/yolo/yolov4_custom.cfg'
...
def detect(imagePath):
    ...
    imagePath = "static/images/" + imagePath.split('\\')[-1]
    print(imagePath)
    ...
    #         draw_prediction(imagePrediction, class_ids[i], confidences[i], round(x), round(y), round(x + w), round(y + h), COLORS)
            ...
            if os.path.exists("static/images/cropped-dectecion-{}.{}".format(j,ext)): 
                os.remove("static/images/cropped-dectecion-{}.{}".format(j,ext))
            cv2.imwrite("static/images/cropped-dectecion-{}.{}".format(j,ext), croppedImage)
    if os.path.exists("static/images/object-detection."+ext):    
        os.remove("static/images/object-detection."+ext)
    cv2.imwrite("static/images/object-detection."+ext, imagePrediction)
